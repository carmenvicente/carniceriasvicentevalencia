        ...
        <div className="max-w-screen-xl mx-auto px-4 py-10 flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="md:w-1/2 text-left">
            ...
            <p className="text-gray-700 mb-4" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 500 }}>
              Seleccionamos cuidadosamente productos frescos y de primera calidad para que disfrutes del auténtico 
              sabor de la carne tradicional. Haz tu pedido de forma rápida y sencilla, y ven a recogerlo cómodamente 
              cuando esté listo. Calidad, cercanía y buen servicio, como siempre.
            </p>
            <p className="text-gray-700 mb-4" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 500 }}>
              Descubre nuestra variedad de cortes frescos, embutidos caseros y otros productos gourmet. 
              ¡Bienvenido a nuestra carnicería online de sabor superior!
            </p>
          </div>
