...
export default function AvisoCookies() {
  ...
  const denegarCookies = () => {
    localStorage.setItem('acepto_cookies', 'false');
    setVisible(false);
  };
  ...
  return (
    ...
    >
      {/* Contenedor para el texto y los botones, para alinearlos horizontalmente y centrarlos */}
      <div className="flex flex-col md:flex-row items-center justify-center max-w-5xl w-full px-4"> {/* ¡Aquí está el cambio: max-w-4xl para el contenedor! */}
        {/* Texto de la política de cookies, alineado a la izquierda pero centrado con el contenedor principal */}
        <p className="flex-1 text-left md:text-center mr-0 md:mr-4 mb-4 md:mb-0 text-xs"> {/* text-sm ya estaba, si necesitas más pequeño, cámbialo a text-xs */}
        ...
        {/* Contenedor de botones, a la derecha del texto */}
      ...
      {/* Enlaces de políticas debajo del texto y los botones */}
