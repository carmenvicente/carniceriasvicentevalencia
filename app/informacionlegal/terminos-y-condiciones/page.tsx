  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-screen-xl mx-auto px-4 py-10 text-black" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 500 }}>
        <p className="mb-20">
          Las presentes condiciones regulan expresamente las relaciones surgidas entre el sitio web de{' '}
          <strong>Carnicería Vicente Valencia</strong> y los usuarios que accedan o utilicen los servicios ofrecidos a través del mismo.
        </p>

        <h2 className="text-lg font-semibold mt-8 mb-4">1. Identificación</h2>
        <p className="mb-20">
          Titular: Carnicería Vicente Valencia SL<br />
          CIF: B16188021<br />
        ...
        <p className="mb-20">
          Estas condiciones tienen por objeto regular el acceso y el uso del sitio web, incluyendo la consulta de productos,
          el registro de usuarios y, cuando esté habilitado, la contratación de los productos comercializados en el mismo.
        </p>
        ...
        */}
        ...
        <h2 className="text-lg font-semibold mt-8 mb-4">3. Propiedad intelectual</h2>
        <p className="mb-6">
          Todos los contenidos del sitio web son propiedad de Carnicería Vicente Valencia o cuentan con licencia
          de uso, y están protegidos por la legislación vigente. Queda prohibida su reproducción o distribución
          sin autorización expresa y por escrito del RESPONSABLE.
        </p>
        <p className="mb-20">
          <strong>Fotografías:</strong> Las fotografías publicadas en este sitio web han sido realizadas por{' '}
          <strong>Carmen Vicente Crespo</strong> y son de su exclusiva propiedad intelectual, con todos los derechos
          reservados. Queda expresamente prohibida su reproducción, distribución, comunicación pública, transformación
          o cualquier otra forma de explotación, con o sin ánimo de lucro, sin la autorización previa y por escrito
          de su autora. Para solicitar permiso de uso, contactar en: carniceriavicentevalencia@gmail.com
        </p>

        <h2 className="text-lg font-semibold mt-8 mb-4">4. Protección de datos</h2>
        <p className="mb-20">
          El tratamiento de los datos personales de los usuarios se rige por lo establecido en nuestra{' '}
          <Link href="/informacionlegal/politica-de-privacidad" className="text-blue-600 hover:underline">
            Política de Privacidad
          </Link>. El usuario puede ejercer sus derechos escribiendo a carniceriavicentevalencia@gmail.com.
        </p>

        <h2 className="text-lg font-semibold mt-8 mb-4">5. Legislación y jurisdicción</h2>
        <p className="mb-20">
          Estas condiciones se rigen por la legislación española. En caso de disputa, las partes se someten
          a los Juzgados y Tribunales de Cuenca, salvo que la normativa establezca lo contrario.
        </p>
